...
I asked AI tool google Gemini to create the codes for generating a synthetic dataset that will look like the cleaned dataset done by Andrew. It contains reporting area, the number of wwmr week in a physical year, cumulative incident of a disease (here for mine is covid) in the first year, incident cases in first year and incident cases in second year.
...
covid_current_week <- round(
  ifelse(runif(num_weeks) < 0.1,  # 10% chance of 0
         0,
         runif(num_weeks, min = 0, max = 18)),  # Remaining 90% with range
  digits = 0
)
